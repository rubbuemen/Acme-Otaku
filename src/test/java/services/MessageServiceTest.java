...
public class MessageServiceTest extends AbstractTest {
	 ...
	 *         Analisis de cobertura de sentencias: 86,09% 196/238 instrucciones
	 *         Analisis de cobertura de datos: alto
	 */
	...
	public void driverCreateMessage() {
		...
		final Object testingData[][] = {
			{
				"admin", "subjectTest", "bodyTest", "HIGH", recipientsMessage, null
			}, {
				null, "subjectTest", "bodyTest", "HIGH", recipientsMessage, IllegalArgumentException.class
			}, {
				"admin", "", "bodyTest", "HIGH", recipientsMessage, ConstraintViolationException.class
			}, {
				"admin", "subjectTest", "", "HIGH", recipientsMessage, ConstraintViolationException.class
			}, {
		...
		final Object testingData[][] = {
			{
				...
				"seller1", "message1", IllegalArgumentException.class
			}
		};
	...
	public void driverBroadcastMessage() {
		final Object testingData[][] = {
			{
				"admin", "subjectTest", "bodyTest", "HIGH", null
			}, {
				null, "subjectTest", "bodyTest", "HIGH", IllegalArgumentException.class
			}, {
				"admin", "", "bodyTest", "HIGH", ConstraintViolationException.class
			}, {
				"admin", "subjectTest", "", "HIGH", ConstraintViolationException.class
			}, {
	...
	private Collection<Actor> recipientsMessage() {
		...
		final Visitor visitor = (Visitor) this.actorService.findOne(super.getEntityId("visitor1"));
		final Member member = (Member) this.actorService.findOne(super.getEntityId("member1"));
		recipientsMessage.add(visitor);
