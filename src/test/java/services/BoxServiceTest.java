...
public class BoxServiceTest extends AbstractTest {
	 ...
	 *         Analisis de cobertura de sentencias: 83,3% 104/120 instrucciones
	 *         Analisis de cobertura de datos: alto
	 */
	@Test
		...
		final Object testingData[][] = {
			{
				...
				"member1", "box6", "nameTest", IllegalArgumentException.class
			}, {
		...
		final Object testingData[][] = {
			{
				...
				"member1", "box6", IllegalArgumentException.class
			}, {
