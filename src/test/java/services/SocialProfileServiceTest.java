...
public class SocialProfileServiceTest extends AbstractTest {
	...
	public void driverListSocialProfiles() {
		...
		for (int i = 0; i < testingData.length; i++)
			this.listSocialProfilesTemplate((String) testingData[i][0], (Class<?>) testingData[i][1]);
	}
	...
	protected void listSocialProfilesTemplate(final String username, final Class<?> expected) {
		Class<?> caught = null;
