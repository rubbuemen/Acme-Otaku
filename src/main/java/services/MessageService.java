...
public class MessageService {
	...
	public Message save(final Message message, final boolean notification) {
		...
		if (result.getFlagSpam()) {
			result.getSender().setIsSuspicious(true);
	...
	public void delete(final Message message) {
		...
		// When an actor removes a message from a box other than trash box, it is moved to the trash box; when he or she removes it from the trash box, then it is actually removed from his folders; when a message is not in any folder, it's actually removed from the system
